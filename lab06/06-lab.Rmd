...
abstracts <- stringr::str_remove_all(abstracts, "</*AbstractText>")
#abstracts <- stringr::str_remove_all(abstracts, "[CLEAN ALL EXTRA WHITE SPACE AND NEW LINES]")
...
titles <- stringr::str_remove_all(titles, "[</*ArticleTitle>]")
...
kable_output <- knitr::kable(database, "html")
kable_output <- kableExtra::kable_styling(kable_output, "striped", full_width = F)
kable_output <- kableExtra::column_spec(kable_output, 1, width = "10em")
kable_output <- kableExtra::column_spec(kable_output, 2, width = "20em")
kable_output <- kableExtra::column_spec(kable_output, 3, width = "30em")
kable_output <- kableExtra::scroll_box(kable_output, width = "100%", height = "500px")
kable_output
...
The HTML link:
https://github.com/Vantion24601/JSC370-labs/blob/master/lab06/06-lab.html
```md
View the rendered HTML version of the lab [here](https://cdn.jsdelivr.net/gh/Vantion24601/JSC370-labs@master/lab06/06-lab.html).
```
